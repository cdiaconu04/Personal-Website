...
const ContactBackground = ({ inView }) => {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none h-screen">
                <motion.svg
                    ...
                    animate="visible"
                >
                    <motion.line x1="-400" y1="30" x2="550" y2="30" stroke={lineColour} // Horizontal
                        style={{
                            strokeWidth: 2,
                            strokeLinecap: "round",
                            fill: "transparent",
                        ...
                        custom={1}
                    />
                    <motion.line x1="80" y1="30" x2="145" y2="90" stroke={lineColour} //Diagonal
                        style={{
                            strokeWidth: 2,
                            strokeLinecap: "round",
                            fill: "transparent",
                        ...
                        custom={1}
                    />
                    <motion.line x1="145" y1="90" x2="400" y2="90" stroke={lineColour} // Horizontal
                        style={{
                            strokeWidth: 2,
                            strokeLinecap: "round",
                            fill: "transparent",
                        ...
                        custom={1}
                    />
                    <motion.circle cx="555" cy="30" r="5" stroke={circleColour}
                        style={{
                            strokeWidth: 2,
                            strokeLinecap: "round",
                            fill: "transparent",
                        ...
                        custom={1}
                    />
                    <motion.circle cx="405" cy="90" r="5" stroke={circleColour}
                        style={{
                            strokeWidth: 2,
                            strokeLinecap: "round",
                            fill: "transparent",
