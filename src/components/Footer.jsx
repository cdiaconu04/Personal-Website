...
const Footer = ({onInView, onOutOfView}) => {
    ...
    return (
        <div className="w-full bg-black relative inline-block border-t border-white/10 overflow-hidden transition duration-200" ref={ref}>
            <p className="absolute inset-0 flex items-center justify-end pr-10 xl:pr-32 text-[10rem] xl:text-[16rem] font-extrabold text-white/5 select-none pointer-events-none leading-none">
                CD
            </p>
            ...
            ">
                <div className="flex flex-col gap-1">
                    <h3 className="text-white font-bold transition duration-200
                ...
                ">
                    <motion.a href="https://linkedin.com/in/cdiaconu04" target="_blank" whileHover={{ scale: 1.09 }}>
                        <FaLinkedin className="text-gray-300 transition duration-200
                    ...
                    <motion.a href="https://github.com/cdiaconu04" target="_blank" whileHover={{ scale: 1.09 }}>
                        <FaGithub className="text-gray-300 transition duration-200
                            2xl:w-8 2xl:h-8 lg:w-7 lg:h-7 md:w-6 md:h-6 w-6 h-6
                        "/>
                    </motion.a>

                    <motion.a href="mailto:cristian.diaconu0423@gmail.com" whileHover={{ scale: 1.09 }}>
                        <Mail className="text-gray-300 transition duration-200
                            2xl:w-8 2xl:h-8 lg:w-7 lg:h-7 md:w-6 md:h-6 w-6 h-6
                        "/>
                    </motion.a>
                </div>
